...
public class BackendsProcDir implements ProcDirInterface {
    ...
    static {
        ImmutableList.Builder<String> builder = new ImmutableList.Builder<String>()
                ...
                .add("DataCacheStatus").add("DataCacheDiskUsage").add("DataCacheMemUsage").add("DataCacheMetaUsage");
    ...
    public static List<List<String>> getClusterBackendInfos() {
        ...
        for (long backendId : backendIds) {
            ...
            if (dataCacheMetrics.isPresent()) {
                backendInfo.add(dataCacheMetrics.get().getStatus().getName());
                backendInfo.add(dataCacheMetrics.get().getDiskUsage());
                backendInfo.add(dataCacheMetrics.get().getMemUsage());
                backendInfo.add(dataCacheMetrics.get().getMetaUsage());
            } else {
                backendInfo.add("Disabled");
                backendInfo.add("N/A");
                backendInfo.add("N/A");
                backendInfo.add("N/A");
            }
