...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public boolean isEnableDataCacheCopilotIgnoreStarScan() {
        return enableDataCacheCopilotIgnoreStarScan;
    }

    public void setEnableDataCacheCopilotIgnoreStarScan(boolean enableDataCacheCopilotIgnoreStarScan) {
        this.enableDataCacheCopilotIgnoreStarScan = enableDataCacheCopilotIgnoreStarScan;
    }
