...
public class StatisticUtils {
    ...
    public static List<ColumnDef> buildStatsColumnDef(String tableName) {
        ...
        if (tableName.equals(StatsConstants.SAMPLE_STATISTICS_TABLE_NAME)) {
            ...
            return ImmutableList.of(
                    new ColumnDef(DataCacheCopilotConstants.CATALOG_COLUMN_NAME, new TypeDef(catalogNameType)),
                    new ColumnDef(DataCacheCopilotConstants.DATABASE_COLUMN_NAME, new TypeDef(dbNameType)),
                    new ColumnDef(DataCacheCopilotConstants.TABLE_COLUMN_NAME, new TypeDef(tableNameType)),
                    new ColumnDef(DataCacheCopilotConstants.PARTITION_COLUMN_NAME, new TypeDef(partitionNameType)),
                    new ColumnDef(DataCacheCopilotConstants.COLUMN_COLUMN_NAME, new TypeDef(columnNameType)),
                    new ColumnDef(DataCacheCopilotConstants.ACCESS_TIME_COLUMN_NAME, new TypeDef(accessTimeType)),
                    new ColumnDef(DataCacheCopilotConstants.COUNT_COLUMN_NAME, new TypeDef(countType), false,
